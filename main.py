...
class CarHandler(webapp2.RequestHandler):
    ...
    def post(self): #post request handler
		...
		email = getUserEmail('ya29.Glx5Bd25s6NEkvJ_6sgGnT7RufFz0uUsCQY--mL6ZcyW-dSlbBeCZgTPi5QQ2SkaUtZzy7jZv7EsHnopR3t8JhwRdfU8rTk62UtEdt522K5TjSbT9al1zYWCm2S07w')
                #new_car = Car(id="", year=yearVar, make=makeVar, model=modelVar, in_space=False, owner_id=email) 
		new_car = Car(id="", year=yearVar, make=makeVar, model=modelVar, in_space=False, owner_id=" ") 
                #assign values 
